    ...
    <div class="box-content">
        ...
        <form action="{{ route('pembayaran.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nomor_pembayaran" id="nomor_pembayaran" class="form-control" value="{{ old('nomor_pembayaran') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="date" name="tanggal_pembayaran" id="tanggal_pembayaran" class="form-control" value="{{ old('tanggal_pembayaran') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="jumlah_pembayaran" id="jumlah_pembayaran" class="form-control" value="{{ old('jumlah_pembayaran') }}" required>
            ...
            <div class="form-group">
                ...
                <select name="kamar_id" id="kamar_id" class="form-control" required>
                    ...
                    @foreach($kamar as $k)
                        <option value="{{ $k->id }}" {{ old('kamar_id') == $k->id ? 'selected' : '' }}>{{ $k->nomor }}</option>
                    @endforeach
                </select>
                @error('kamar_id')
                <small class="text-danger">{{ $message }}</small>
